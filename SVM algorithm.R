...
#SVM model is used to predict the species of iris flowers.The confusion matrix displayed count of correct and incorrect 
#predictions for each species. 
# From this, the miss classification rate is calculated = 2.66%

#What is the accuracy rate?
accuracy_rate <- 1-misclassification_rate

# accuracy rate of the model 97.33%
