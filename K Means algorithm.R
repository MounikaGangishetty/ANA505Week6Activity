...
# Data is classified into three clusters.With incorrect and correct classification
# an accuracy of 88.66% is considered  which is reasonably good ,but anyway the performance can vary depending on  
# dataset provided and  k-means clustering.

#TASK: Accuracy = number of correctly classified/(total classified) = ?
#i.e our model has achieved ?% accuracy!

accuracy_rate <- 133/150

# our model has achieved 88.66% accuracy
